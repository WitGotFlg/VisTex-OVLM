...
def inference(
    ...
    if not cfg.SOLVER.TEST_WITH_INFERENCE:
        ...
        with torch.no_grad():
            if cfg.TEST.USE_MULTISCALE:
                ...
                for query_i in range(query_time):
                    ...
                    if cfg.IMPROMPT.gvl:#wuyongjian: debug code ,remember to delete
                        if imprompt is None:
                    ...
                    if "flickr" in cfg.DATASETS.TEST[0]:
                        ...
                        all_output.append(output)
        if visualizer is not None and not cfg.SOLVER.TEST_WITH_INFERENCE:
